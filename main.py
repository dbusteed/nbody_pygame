...
start_menu = UIPanel(Rect(start_menu_pad_x, start_menu_pad_y, WIDTH-(start_menu_pad_x*2), HEIGHT-(start_menu_pad_y*2)), starting_height=1, manager=ui)
...
nbody_slider = UIHorizontalSlider(Rect(start_menu.rect.width / 2, 162.5, 150, 25), 20, (5, 200), manager=ui, container=start_menu)
...
hud = UIPanel(Rect(5, HEIGHT-hud_height, WIDTH-10, hud_height), starting_height=1, manager=ui, margins=no_margin)
hud.hide()
hide_hud = False
help_pnl_width = (1/3 * WIDTH)
help_pnl = UIPanel(Rect(0, 0, help_pnl_width, hud_height), starting_height=1, manager=ui, container=hud, margins=no_margin)
info_pnl = UIPanel(Rect(help_pnl_width-5, 0, (WIDTH-help_pnl_width-5), 50), starting_height=1, manager=ui, container=hud)
btns_pnl = UIPanel(Rect(help_pnl_width-5, hud_height-50-5, (WIDTH-help_pnl_width-5), 55), starting_height=1, manager=ui, container=hud)
